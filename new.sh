...
echo $i" |"$cy"     TESLIAN TECH"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MICHAEL AD TESLA  [FR13ND8]"$i"          |"
echo $i" |"$pu" INSTAGRAM :"$ku" MICHAEL TESLA5656"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.BEEM] [MR.JAVED] [MR.SERGUI]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [JAMES]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 917722981287"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" TESLIANTECH@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $cy"Teslian type"
sleep 2
echo $i"teslian tech tech on your feet"
sleep 2
echo $ku"WhatsApp :"$i" 917722981287"
echo $ku"Facebook :"$i" Michael Tesla"
sleep 2
echo $pur">> Thanks teslian tech 4 Support Saya <<"
exit
fi